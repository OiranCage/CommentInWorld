...
class CommentBubble extends Entity {
	...
	public function saveNBT(): CompoundTag{
		...
		$commentCompoundTag->getString(CommentBubble::TAG_POSTER, $this->comment->getPoster());
		$commentCompoundTag->getInt(CommentBubble::TAG_CREATED_TIME, $this->comment->getCreatedTime()->getTimestamp());
